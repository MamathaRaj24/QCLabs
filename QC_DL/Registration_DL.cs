...
namespace QC_DL
{
    ...
    {
        public DataTable SampleRegistration(Registration_BE objbe, string ConnKey)
        {
        ...
        public DataTable SampleRegistrationDI(Registration_BE objbe, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable MemoID(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable CourierIUDR(Registration_BE objBE, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        //PrintForm1718 --Rajesh
        public DataTable PrintForm1718(Registration_BE objBE, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
                using (SqlDataAdapter da = new SqlDataAdapter("PrintMemoNForms", con))
                {
                    ...
                    da.SelectCommand.Parameters.Add("@Year", SqlDbType.VarChar).Value = objBE.ExpiryDate;
                    da.SelectCommand.Parameters.Add("@Action", SqlDbType.VarChar).Value = objBE.Action;
                    DataTable dt = new DataTable();
                    da.Fill(dt);
                    return dt;
        ...
        //UserRegistration --Rajesh
        public DataTable UserRegistration_IUDR(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable FertlizerRegistration(Registration_BE objbe, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable SampleRegister(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable GenerateSticker(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable UOAction(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable JAAction(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        //Edit TestResult
        public DataTable JAActionEdit(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable DashBoard(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable PrintForm13(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
                using (SqlDataAdapter da = new SqlDataAdapter("AnalystAction", con))
        ...
        public DataTable PesticideRegistration(Registration_BE objbe, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable SeedRegistration(Registration_BE objbe, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        //Analyst Dashboard
        public DataTable AnalystDashBoard(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        //
        public DataTable bulkdata(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
        ...
        public DataTable searchsample(Registration_BE obj, string ConnKey)
        {
            using (SqlConnection con = new SqlConnection(ConnKey))
            {
