<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgriSample.aspx.cs" Inherits="AgriAdmin_AgriSample" %>
                            ...
                            <div class="span4">
                                <div class="control-group">
                                    <label class="control-label" for="txtSampName">
                                        Sample Name</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtSampName" CssClass="form-control" MaxLength="100" runat="server"
