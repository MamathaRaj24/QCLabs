...
public partial class Agri_Admin_DashBoard : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["UsrName"] != null && Session["RoleID"].ToString() == "7")
        {
    ...
    protected void GetDetails()
    {
        try
        {
            ...
            dt = Objrdl.DashBoard(objR, con);
            if (dt.Rows.Count > 0)
                lblSamTested.Text = dt.Rows[0]["NOAP"].ToString();
