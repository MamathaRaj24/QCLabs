﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Agri_Login" %>
...
<head id="Head1" runat="server">
    ...
    <title>QC LABS | Department Of Agriculture</title>
...
<body>
    ...
    <div class="main_header">
        <div class="header">
            <div class="container-fluid" style="background-color: #00ba8b; color: White">
                ...
                <div class="row">
                    <div class="span12">
                        ...
                        <div class="span5 right">
                            Content Maintained and Updated by Department Of Agriculture
                            <img src="../Assets/img/DOA.png" alt="" />
                        </div>
                    </div>
                </div>
            </div>
