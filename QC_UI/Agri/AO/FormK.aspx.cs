...
public partial class AO_FormK : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                GvprintformK.DataSource = dt;
                GvprintformK.DataBind();
            }
            else
            {
                GvprintformK.DataSource = null;
                GvprintformK.DataBind();
    ...
    protected void GvprintformK_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "Print-K")
            {
    ...
    protected void Printformk()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Rpt_PrintFormJ.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~/RdlcReports/K-form.rdlc");
