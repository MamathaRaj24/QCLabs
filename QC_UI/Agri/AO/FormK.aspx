<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormK.aspx.cs" Inherits="AO_FormK" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'FormK.aspx');
                ...
                <div class="row">
                    <div class="widget ">
                        ...
                        <div class="widget-content">
                            ...
                            <asp:GridView ID="GvprintformK" runat="server" CssClass="table table-striped table-bordered"
                                GridLines="None" AutoGenerateColumns="False" 
                                onrowcommand="GvprintformK_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Print-K">
                                        <ItemTemplate>
                                            <asp:Button ID="btnprintj" runat="server" CommandName="Print-K" formnovalidate Text="Print-K" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
