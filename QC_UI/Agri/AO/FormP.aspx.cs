...
public partial class AO_FormP : System.Web.UI.Page
{
    ...
    protected void Printformj()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Rpt_PrintFormJ.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~/RdlcReports/P-form.rdlc");
