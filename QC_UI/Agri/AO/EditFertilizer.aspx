<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditFertilizer.aspx.cs" Inherits="AO_EditFertilizer" %>
...
<head runat="server">
   ...
   <%-- <script type="text/javascript">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'EditFertilizer.aspx');
    ...
    <div class="main">
        <div class="main-inner">
            <div class="container" style="margin-top: -30px;">
                ...
                <div class="row">
                    <div class="widget ">
                        <div class="widget-header">
                            ...
                            <h3 align="center">
                                DELETE / UPDATE FERTILIZER SAMPLE</h3>
                        </div>
                ...
                <asp:Panel ID="pnleditfertilizer" runat="server">
                    <div class="row">
                        <div class="widget ">
                            <div class="widget-header coler">
                                <i class="icon-reorder"></i>
                                <h3 align="center">
                                    Edit Fertilizer Registration</h3>
                                <h1 class="alert alert-info">
                                    <asp:Label ID="lblFertilizerno" Visible="false" runat="server"></asp:Label>
                                </h1>
                            </div>
                            <div class="widget-content">
                                <fieldset>
                                    <div class=" form-group">
                                        <div class=" form-group">
                                            ...
                                            <div class="col-lg-2 col-md-2">
                                                ...
                                                <ajaxToolkit:FilteredTextBoxExtender ID="txtcodesampleFilteredTextBoxExtender1" runat="server"
                            ...
                            <div class="widget-content">
                                <fieldset>
                                    <div class=" form-group">
                                        <label class="col-lg-2 col-md-2">
                                            Name of the Firm/Dealer: <span style="color: Red">*</span>
                                        </label>
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtfirnmdlr" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server" required></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtfirnmdlr_FilteredTextBoxExtender" runat="server"
                                                BehaviorID="txtfirnmdlr_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                TargetControlID="txtfirnmdlr" ValidChars=" .,()-'">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </div>
                                        <label class="col-lg-2 col-md-2">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtnmowner" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtnmowner_FilteredTextBoxExtender" runat="server"
                                                BehaviorID="txtnmowner_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                TargetControlID="txtnmowner" ValidChars=" .,()-'">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </div>
                                        <label class="col-lg-2 col-md-2">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtdllcno" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtdllcno_FilteredTextBoxExtender" runat="server"
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtvldty" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server"></asp:TextBox>
                                        </div>
                                        <label class="col-lg-2 col-md-2">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtbthchno" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtbthchno_FilteredTextBoxExtender" runat="server"
                                                BehaviorID="txtbthchno_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                TargetControlID="txtbthchno" ValidChars=" .,()-'">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </div>
                                        <label class="col-lg-2 col-md-2">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtstockl" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtstockl_FilteredTextBoxExtender" runat="server"
                                                BehaviorID="txtstockl_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                TargetControlID="txtstockl" ValidChars=" .,()-'">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </div>
                                    </div>
                                    <div class=" form-group">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txthsno" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server" required></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="txthsno_FilteredTextBoxExtender" runat="server"
                                                BehaviorID="txthsno_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtlcstr" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server" required></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtlcstr_FilteredTextBoxExtender" runat="server"
                                                BehaviorID="txtlcstr_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                TargetControlID="txtlcstr" ValidChars=" .,()-'">
                                            </ajaxToolkit:FilteredTextBoxExtender>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:TextBox ID="txtdmipagency" CssClass="form-control" AutoComplete="off" MaxLength="50"
                                                runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </fieldset>
                            ...
                            <div class="widget-content">
                                <fieldset>
                                    <div class=" form-group">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            <asp:DropDownList ID="ddlsampleType" runat="server" CssClass="form-control" AutoPostBack="true"
                                                OnSelectedIndexChanged="ddlsampleType_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </div>
                                        <label class="col-lg-1 col-md-1">
                                            Sample Name <span style="color: Red">*</span>
                                        </label>
                                        <div class="col-lg-2 col-md-2">
                                        ...
                                        <div class="col-lg-2 col-md-2">
                                            ...
                                            <asp:Label ID="lbldtprmid" runat="server"></asp:Label>
                                        </div>
                                    </div>
                                    <%--<div class="widget-content">
                                        <asp:GridView ID="GvSpec" runat="server" CssClass="table table-striped table-bordered"
                                            AutoGenerateColumns="false" OnRowDataBound="GvSpec_RowDataBound">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SlNo">
                                                    <ItemTemplate>
                                                        <%#Container.DataItemIndex+1 %>
                                                ...
                                                <asp:TemplateField HeaderText="Specification">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblspecid" Visible="false" Text='<%# Bind("SpecificationId") %>' runat="server"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <div class="widget-content">
                                <fieldset>
                                    <div class=" form-group">
                                        <label class="col-lg-2 col-md-2">
                                            Date of Manufacturery<span style="color: Red">*</span>
                                        </label>
                                        <div class="col-lg-2 col-md-2">
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <label class="col-lg-2 col-md-2">
                                            Weahetr Samples drwan from<span style="color: Red">*</span>
                                        </label>
                                        <div class="col-lg-2 col-md-2">
                            ...
                            <div class="form-actions">
                                <asp:Button ID="btnupdate" formnovalidate="formnovalidate" Text="Update Fertilizers"
                                    class="btn btn-primary " CausesValidation="false" runat="server" OnClick="btnupdate_Click" />
