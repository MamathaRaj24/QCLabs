<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintformJ.aspx.cs" Inherits="AO_PrintformJ" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'PrintformJ.aspx');
                        ...
                        <div class="widget-content">
                            ...
                            <asp:GridView ID="Gvprintformj" runat="server" CssClass="table table-striped table-bordered"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Print-J">
                                        <ItemTemplate>
                                            <asp:Button ID="btnprintj" runat="server" CommandName="Print-j" formnovalidate Text="Print-J" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
