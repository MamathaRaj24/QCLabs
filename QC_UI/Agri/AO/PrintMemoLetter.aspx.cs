...
public partial class AO_PrintMemoLetter : System.Web.UI.Page
{
    ...
    protected void Printformj()
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Rpt_PrintFormJ.LocalReport.ReportPath = HttpContext.Current.Server.MapPath("~/RdlcReports/Rpt_Memo_Letter_Ao.rdlc");
