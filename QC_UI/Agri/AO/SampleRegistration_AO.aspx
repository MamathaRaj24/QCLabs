<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SampleRegistration_AO.aspx.cs"
    Inherits="AO_SampleRegistration_AO" %>
...
<head runat="server">
    <title>AO-Sample Registration</title>
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'SampleRegistration_AO.aspx');
