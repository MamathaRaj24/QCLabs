<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormP.aspx.cs" Inherits="AO_FormP" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'FormP.aspx');
                    ...
                    <div class="widget ">
                        ...
                        <div class="widget-content">
                            ...
                            <asp:GridView ID="Gvprintformj" runat="server" CssClass="table table-striped table-bordered"
                                ...
                                onrowcommand="Gvprintformj_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Print-P">
                                        <ItemTemplate>
                                            <asp:Button ID="btnprintj" runat="server" CommandName="Print-P" formnovalidate Text="Print-P" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
