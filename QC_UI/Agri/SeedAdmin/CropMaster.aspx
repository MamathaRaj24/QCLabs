<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CropMaster.aspx.cs" Inherits="Agri_SeedAdmin_CropMaster" %>
   ...
   <title>SeedAdmin-Crop</title>
    ...
    <script type="text/javascript">
        function Confirm(link) {
            if (confirm("Are you sure to delete the selected Crop?")) {
                return true;
            }
            else
                return false;
            ...
            <div class="container" style="margin-top: -30px;">
                ...
                <div class="row">
                    <div class="widget ">
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    <label class="control-label" for="username">
                                        Crop Name</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtcropname" CssClass="form-control" AutoComplete="Off" MaxLength="50"
                                            runat="server"></asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtcropname_FilteredTextBoxExtender"
                                            runat="server" BehaviorID="txtcropname_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                            TargetControlID="txtcropname" ValidChars=" .,()-">
                        ...
                        <div class="widget-content">
                            <asp:GridView ID="GvCrop" runat="server" CssClass="table table-striped table-bordered"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Crop Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLabCode" runat="server" Visible="false" Text='<%# Bind("CropCode") %>'>
                                            </asp:Label>
