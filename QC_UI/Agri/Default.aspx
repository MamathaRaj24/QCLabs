<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Agri_Default" %>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <div class="container">
        <div class="row align-items-center position-relative">
            ...
            <div class="site-logo">
              <a href="#" class="navbar-brand" ><img  id="headerimg" src="../Assets/img/agri_header.png" alt="Urbanic Template" title="Urbanic Template" /></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="owl-carousel slide-one-item">
                    <div class="site-section-cover overlay img-bg-section" style="background-image: url('../Assets/img/agrislider/slide1.png');">
                        <div class="container">
                    ...
                    <div class="site-section-cover overlay img-bg-section" style="background-image: url('../Assets/img/agrislider/slide2.jpg');">
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                    ...
                    <div class="site-section-cover overlay img-bg-section" style="background-image: url('../Assets/img/agrislider/slide3.jpg');">
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-md-12 col-lg-8">
                                    <h1 data-aos="fade-up" data-aos-delay="">
                    ...
                    <div class="site-section-cover overlay img-bg-section" style="background-image: url('../Assets/img/agrislider/slide4.jpg');">
                        <div class="container">
                            <div class="row align-items-center justify-content-center text-center">
                                <div class="col-md-12 col-lg-8">
                                    <h1 data-aos="fade-up" data-aos-delay="">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-3 mb-3" data-aos="fade-up" data-aos-delay="200">
                                <div class="block__35630">
                                    <div class="icon mb-3">
                                        <%-- <img src="../Assets_Home/images/notasper.png" style="height: 68px; width: 68px;" /> --%>
                ...
                <div class="container">
                    <div class="row d-flex no-gutters align-items-stretch">
                        <div class="col-lg-10 ml-auto p-lg-5 mt-4 mt-lg-0">
                            <h2 class="section-title text-primary">
                                <strong>Agriculture</strong> Department</h2>
                            <p>
                                The objectives of the Department are to assess requirements of agriculture inputs
                                well in advance and to regulate their production and monitor timely supply of seeds,
                                fertilizers and pesticides, implements, credit etc., to farmers.
                               </p>
                        </div>
                        <div class="col-8 col-lg-2 block__73422" style="background-image: url('../Assets/img/doctors.png'); height="200px" ">
                        </div>
                    </div>
                </div>
            </div>
