<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenerateStickers.aspx.cs" Inherits="Agri_CodingCenter_GenerateStickers" %>
<%@ Register TagPrefix="Menu" TagName="menu" Src="~/Agri/CodingCenterADA/Menu.ascx" %>
                    ...
                    <div class="widget ">
                        ...
                        <div class="widget-content">
                            ...
                            <div class="span12">
                                <div class="span3">
                                    <div class="span4">
                                        <asp:ImageButton ID="btnImgprint" runat="server" Width="20%" Visible="false" ImageUrl="~/Assets/img/print-button.png"
