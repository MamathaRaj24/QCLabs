<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllotLab.aspx.cs" Inherits="Agri_Fertilizer_CCODDA_AllotLab" %>
...
<head runat="server">
     <title>Coding Center ADA - Allot Lab</title>
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    <label class="control-label" for="username">
                                        Memo ID</label>
                                    <div class="controls">
                                        <asp:DropDownList ID="ddlmemo" CssClass="form-control " Height="35px" required
                                            runat="server">
                                        </asp:DropDownList>
                                    </div>
                                </div>
