...
public partial class Agri_Fertilizer_Labofficer_Ack : System.Web.UI.Page
{
    ...
    protected void btnAck_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (GridViewRow gr in GVAck.Rows)
            {
                ...
                //string sampleid = ((Label)gr.FindControl("lblsampleid")).Text.Trim();

            }
            objBE.AckTVP = ddt;
           // objBE.dept = dept;
            objBE.UserId = Session["COLabcode"].ToString();
