<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InformationSheet.aspx.cs"
    Inherits="Agri_Fertilizer_CCOAO_InformationSheet" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        history.pushState(null, null, 'InformationSheet.aspx');
                ...
                <div class="row">
                    <div class="widget ">
                        ...
                        <div class="span5">
                            <div class="control-group">
                                <div class="controls">
                                    <asp:Button ID="btnSave" runat="server" Text="Get Information sheet" CssClass="btn btn-primary"
                        ...
                        <div class="span12">
                            <div class="span3">
                                <div class="span4">
                                    <asp:ImageButton ID="btnImgprint" runat="server" Width="20%" formnovalidate Visible="false"
                                        ImageUrl="~/Assets/img/print-button.png" onclick="btnImgprint_Click"/>
                                </div>
                            </div>
                            <div class="span12">
