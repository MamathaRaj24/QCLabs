...
public partial class DCA_Analyst_RAViewtestresultrpt : System.Web.UI.Page
{
    ...
    protected void GVTestResult_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "ViewResult")
        {
            try
            {
                ...
                objBE.SampleID = ((Label)gvrow.FindControl("lblsampleid")).Text;
                //objBE.Action = "RDLC-JA";
                objBE.Action = "RARDLC-JAFORM";
                dt = ObjDL.JAActionEdit(objBE, con);
                objBE.Action = "RARDLC-JATEST";
