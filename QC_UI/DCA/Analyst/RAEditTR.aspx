<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RAEditTR.aspx.cs" Inherits="DCA_Analyst_RAEditTestResult" %>
                ...
                <div class="row">
                    <div class="widget ">
                        <div class="widget-header">
                            <i class="icon-user"></i>
                            <h3 align="center">
                                Re-Alloted Edit Test Results</h3>
                        </div>
                        <asp:Panel ID="pnltestresult" runat="server" ScrollBars="Both">
                                ...
                                <asp:GridView ID="GVTestResult" runat="server" CssClass="table table-striped table-bordered table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="false">
                                            <ItemTemplate>
                                                <asp:Button ID="Btnbufferstage" runat="server" CommandName="BS" formnovalidate Text="Buffer Stage " />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                ...
                                <div id="edttrgrid" runat="server" visible="false">
                                    <div class="col-md-12 table-responsive">
                                        <asp:GridView ID="Gvedittest" runat="server" CssClass="table table-striped table-bordered table-hover"
                                            ...
                                            OnRowCancelingEdit="Gvedittest_RowCancelingEdit" OnRowUpdating="Gvedittest_RowUpdating"
                                            OnRowEditing="Gvedittest_RowEditing" OnRowDataBound="Gvedittest_RowDataBound">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Claim ">
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtedtValueClaim" MaxLength="20" Text='<%# Eval("claim") %>' runat="server"></asp:TextBox>
                    ...
                    <div class="row" id="EdtBufferstage" runat="server" visible="false">
                        <div class="widget ">
                            <div class="widget-header">
                                <i class="icon-user"></i>
                                <h3 align="center">
                                    Edit Buffer Stage Test Result
                                    <asp:Label ID="lblbssampleid" runat="server" CssClass="alert alert-info"></asp:Label>
                                </h3>
                            </div>
                            <div class="widget-content">
                                <div class="col-md-12 table-responsive">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12 text-center">
                                        <asp:Button ID="btnbuffer" CssClass="btn btn-primary" runat="server" CausesValidation="false"
                                            formnovalidate Text="Update Buffer Stage" OnClick="btnbuffer_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
