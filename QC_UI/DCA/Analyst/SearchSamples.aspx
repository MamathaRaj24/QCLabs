<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchSamples.aspx.cs" Inherits="DCA_Analyst_SearchSamples" %>
...
<head runat="server">
    <title>Junior Analyst-Search Samples </title>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class=" col-4 text-left">
                                                <asp:DropDownList ID="ddlSampId" CssClass="form-control" runat="server" 
                                                    AutoPostBack="true" onselectedindexchanged="ddlSampId_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center">
                                            <asp:Button ID="BtnTR" CssClass="btn btn-primary" runat="server" ValidationGroup="tr" Visible="false"
                                                Text="Get Data" OnClick="BtnTR_Click1" />
                                        </div>
                                    </div>
                                </div>
                            </div>
