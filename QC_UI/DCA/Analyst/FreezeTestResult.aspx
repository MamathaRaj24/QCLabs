<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FreezeTestResult.aspx.cs"
    Inherits="DCA_Analyst_FreezeTestResult" %>
...
<head runat="server">
    <title>Analyst- Freeze Sample Test Result</title>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 text-center">
                            ...
                            <asp:Button ID="btnFreeze" CssClass="btn btn-primary" CausesValidation="false" runat="server"
                                Text="Freeze And Submit to Unit Officer" OnClick="btnFreeze_Click" />
                        </div>
                    </div>
                </div>
            </div>
