<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TstRslt.aspx.cs" Inherits="Analyst_TestResult" %>
                                            ...
                                            <fieldset>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtsampleValueFoundExtender" runat="server"
                                                            FilterType="Numbers,Custom,UppercaseLetters" TargetControlID="txtsample" ValidChars="-" />
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="widget-content ">
                                                            ...
                                                            <div class=" form-group">
                                                                ...
                                                                <div class="col-md-2 col-lg-4">
                                                                    ...
                                                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtDesc_FilteredTextBoxExtender" runat="server"
                                                                        BehaviorID="txtDesc_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,custom,Numbers"
                                                                        TargetControlID="txtDesc" ValidChars=" .,()/-+*">
                                                                ...
                                                                <div class="col-md-2 col-lg-4">
                                                                    <asp:TextBox ID="txtremarks" TextMode="MultiLine" Height="80px" CssClass="form-control"
                                                                        required runat="server"></asp:TextBox>
                                                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtremarksFilteredTextBoxExtender1" runat="server"
                                                                        BehaviorID="txtremarks_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,custom,Numbers"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="TestFor">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txttestfor" MaxLength="50" CssClass="form-control" Text='<%# Eval("Testfor") %>'
                                                                                runat="server"></asp:TextBox>
                                                                            <ajaxToolkit:FilteredTextBoxExtender ID="txttestfor_FilteredTextBoxExtender" runat="server"
                                                                                BehaviorID="txttestfor_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Test Name (In Case of Others)" Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtTestDone" CssClass="form-control" Text='<%# Eval("TestName") %>'
                                                                                runat="server"></asp:TextBox>
                                                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtTestDone_FilteredTextBoxExtender" runat="server"
                                                                                BehaviorID="txtTestDone_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Found">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtValueFound" MaxLength="20" CssClass="form-control" Text='<%# Eval("found") %>'
                                                                                runat="server"></asp:TextBox>
                                                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtValueFound_FilteredTextBoxExtender" runat="server"
                                                                                BehaviorID="txtValueFound_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Claim">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtValueClaim" MaxLength="20" CssClass="form-control" Text='<%# Eval("claim") %>'
                                                                                runat="server"></asp:TextBox>
                                                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtValueClaim_FilteredTextBoxExtender" runat="server"
                                                                                BehaviorID="txtValueClaim_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Limit">
                                                                        <ItemTemplate>
                                                                            <asp:TextBox ID="txtlimit" MaxLength="20" CssClass="form-control" Text='<%# Eval("limit") %>'
                                                                                runat="server"></asp:TextBox>
                                                                            <ajaxToolkit:FilteredTextBoxExtender ID="txtlimit_FilteredTextBoxExtender" runat="server"
                                                                                BehaviorID="txtlimit_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                                                                        ...
                                                                        <td>
                                                                            <table>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtbscal1" CssClass="form-control" TextMode="MultiLine" runat="server"
                                                                                            Width="100%"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtbscal2" CssClass="form-control" TextMode="MultiLine" runat="server"
                                                                                            Width="100%"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtbscal3" CssClass="form-control" TextMode="MultiLine" runat="server"
                                                                                            Width="100%"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtbscal4" CssClass="form-control" TextMode="MultiLine" runat="server"
                                                                                            Width="100%"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtbscal5" CssClass="form-control" TextMode="MultiLine" runat="server"
                                                                                            Width="100%"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:TextBox ID="txtbscal6" CssClass="form-control" TextMode="MultiLine" runat="server"
                                                                                            Width="100%"></asp:TextBox>
                                                                                    </td>
                                                                                    <td>
