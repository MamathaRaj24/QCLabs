<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm13.aspx.cs" Inherits="CodingOfficer_PrintForm13" %>
                        ...
                        <div class="widget-content">
                            <asp:GridView ID="GvPrintForm" runat="server" CssClass="table table-striped table-bordered"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="BtnView" runat="server" CommandName="ViewResult" formnovalidate Text="Form 13" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
