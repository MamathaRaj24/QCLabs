<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm34.aspx.cs" Inherits="CodingOfficer_PrintForm34" %>
...
<head runat="server">
    <title>Coding Officer--Print Form 34</title>
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'PrintForm34.aspx');
                    ...
                    <div class="widget ">
                        ...
                        <div class="widget-content">
                            <asp:GridView ID="GvPrintForm" runat="server" CssClass="table table-striped table-bordered"
                                AutoGenerateColumns="False" OnRowCommand="GvPrintForm_RowCommand" AllowPaging="true"
                                PageSize="10" OnPageIndexChanging="GvPrintForm_PageIndexChanging">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="A1 Test Result Entered" DataField="A1TestDone" />
                                    <asp:BoundField HeaderText="A2 Test Result Entered" DataField="A2TestDone" />
                                    <asp:BoundField HeaderText="A3 Test Result Entered" DataField="A3TestDone" />
                                    <asp:BoundField HeaderText="B1 Test Result Entered" DataField="B1TestDone" />
                                    <asp:BoundField HeaderText="B2 Test Result Entered" DataField="B2TestDone" />
                                    <asp:BoundField HeaderText="B3 Test Result Entered" DataField="B3TestDone" />
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Button ID="BtnView" runat="server" CommandName="ViewResult" formnovalidate Text="From 34" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
