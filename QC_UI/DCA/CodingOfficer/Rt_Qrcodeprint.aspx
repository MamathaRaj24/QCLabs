<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rt_Qrcodeprint.aspx.cs" Inherits="DCA_CodingOfficer_Rt_Qrcodeprint" %>
...
<head runat="server">
    <title>Coding Officer-Re-allot Qrcode</title>
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'Rt_Qrcodeprint.aspx');
                        ...
                        <div class="widget-content">
                            ...
                            <div class="span4">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:Button ID="btnqrcode" runat="server" Text="QRCODE" 
                                            CssClass="btn btn-primary" onclick="btnqrcode_Click"
                                            />
                                    </div>
                                </div>
                            </div>
