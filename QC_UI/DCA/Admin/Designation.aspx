<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Designation.aspx.cs" Inherits="DCA_Admin_Designation" %>
                        ...
                        <div class="widget-content">
                            <div class="span5">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <asp:TextBox ID="txtdisignation" CssClass="form-control" AutoComplete="Off" MaxLength="50" runat="server"></asp:TextBox>
                                        <ajaxToolkit:FilteredTextBoxExtender ID="txtdisignation_FilteredTextBoxExtender" runat="server"
                                            BehaviorID="txtdisignation_FilteredTextBoxExtender" FilterType="UppercaseLetters, LowercaseLetters,Numbers,custom"
                            ...
                            <asp:GridView ID="Gvdesignation" runat="server" CssClass="table table-striped table-bordered"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Designation Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLabCode" runat="server" Visible="false" Text='<%# Bind("DesignationID") %>'>
                                            </asp:Label>
                                            <asp:Label ID="lblLabName" runat="server" Text='<%# Bind("Designation") %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
