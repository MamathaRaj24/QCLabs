<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLabs.aspx.cs" Inherits="DCA_Admin_AddLabs" %>
                            ...
                            <div class="span5">
                                <div class="control-group">
                                    <label class="control-label" for="username">
                                        Lab Name</label>
                                    <div class="controls">
                                        <asp:TextBox ID="txtLabName" CssClass="form-control" runat="server"></asp:TextBox>
