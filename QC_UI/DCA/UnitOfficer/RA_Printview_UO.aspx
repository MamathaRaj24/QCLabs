<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RA_Printview_UO.aspx.cs"
    Inherits="DCA_UnitOfficer_Printview_UO" %>
...
<head runat="server">
    <title>Unit Officer - Re_Allot View Test Results</title>
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'RA_Printview_UO.aspx');
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="TestCompleted Date">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblbstestdone" runat="server" Visible="false" Text='<%# Bind("A1TestDone") %>'></asp:Label>
                                            <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Bind("A2TestDone") %>'></asp:Label>
                                            <asp:Label ID="Label2" runat="server" Visible="false" Text='<%# Bind("A3TestDone") %>'></asp:Label>
                                            <asp:Label ID="Label3" runat="server" Visible="false" Text='<%# Bind("B1TestDone") %>'></asp:Label>
                                            <asp:Label ID="Label4" runat="server" Visible="false" Text='<%# Bind("B2TestDone") %>'></asp:Label>
                                            <asp:Label ID="Label5" runat="server" Visible="false" Text='<%# Bind("B3TestDone") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
