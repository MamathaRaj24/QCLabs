<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FreezeTestresult_UO.aspx.cs"
    Inherits="DCA_UnitOfficer_FreezeTestresult_UO" %>
...
<head runat="server">
    <title>Unit Officer - Freeze Test Results</title>
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'FreezeTestresult_UO.aspx');
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 text-center">
                            ...
                            <asp:Button ID="btnFreeze" CssClass="btn btn-primary" CausesValidation="false" runat="server"
                                Text="Freeze And Submit Test Result" OnClick="btnFreeze_Click" />
                        </div>
                    </div>
                </div>
            </div>
