<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RA_ViewTestResult.aspx.cs"
    Inherits="DCA_UnitOfficer_RA_ViewTestResult" %>
...
<head runat="server">
    <title>Unit Officer - Realloted View Test Results</title>
                ...
                <div class="row">
                    <div class="widget ">
                        <div class="widget-header">
                            <i class="icon-user"></i>
                            <h3 align="center">
                                Realloted Edit Test Results</h3>
                        </div>
                        <div class="widget-content">
                            <asp:GridView ID="GVTestResult" runat="server" CssClass="table table-striped table-bordered"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="BS Result Entered" Visible="false">
                                        <ItemTemplate>
