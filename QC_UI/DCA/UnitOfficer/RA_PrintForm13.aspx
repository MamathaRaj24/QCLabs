<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RA_PrintForm13.aspx.cs" Inherits="DCA_UnitOfficer_RA_PrintForm13" %>
...
<head runat="server">
    <title>Unit Officer-Realloted Form13</title>
    ...
    <script type="text/javascript">
        history.pushState(null, null, 'RA_PrintForm13.aspx');
                                             ...
                                             <asp:Label ID="lblstatus" runat="server" Visible="false" Text='<%# Bind("TotCompl") %>'></asp:Label>
                                              <asp:Label ID="lbls1testdone" runat="server" Visible="false" Text='<%# Bind("S1TestDone") %>'></asp:Label>
                                                <asp:Label ID="lbls2testdone" runat="server" Visible="false" Text='<%# Bind("S2TestDone") %>'></asp:Label>
                                                  ...
                                                  <asp:Label ID="lblbstestdone" runat="server" Visible="false" Text='<%# Bind("BSTestDone") %>'></asp:Label>
                                                   <asp:Label ID="lblcatid" runat="server" Visible="false"  Text='<%# Bind("Category_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <ItemTemplate>
