<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="DCA_UnitOfficer_Dashboard" %>
                    ...
                    <div class="widget ">
                        ...
                        <div class="widget-content">
                            <div class=" form-group">
                                ...
                                <div class="col-lg-2">
                                    Samples Of Standard<br />
                                    <img src="../../Assets/img/SamplesTested.png" />
                                    <b>
                                        <asp:Label ID="lblSamTested" runat="server"></asp:Label></b>
                                </div>
                                <div class="col-lg-2">
                                    Samples Not of Standard<br />
                                    <img src="../../Assets/img/SamplesTested.png" />
                                    <b>
                                        <asp:Label ID="lblnotstanderd" runat="server"></asp:Label></b>
                                </div>
                            </div>
                        </div>
                    </div>
