<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourierEntry.aspx.cs" Inherits="DI_CourierEntry" %>
                            ...
                            <asp:GridView ID="GvCourier" runat="server" CssClass="table table-striped table-bordered"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="POD/Reference No">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPodNo" runat="server" AutoComplete="Off" CssClass="form-control" MaxLength="10"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
