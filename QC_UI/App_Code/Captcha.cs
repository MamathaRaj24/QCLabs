...
public class Captcha
{
    ...
    public void Captchaimage(int width, int height,string textImage)
    {
        text = textImage;
        SetDimensions(width, height);
        SetFamilyName(fontList[random.Next(0, fontList.Length - 1)]);
        GenerateImage(textImage);
    }
    ...
    private void GenerateImage(string textImage)
    {
        ...
        do
        {
            ...
            size = g.MeasureString(textImage, font);
